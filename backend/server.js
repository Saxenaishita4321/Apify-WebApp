...
// const verifyKeyRoute = require("./routes/verifyKeyRoute"); // ← make sure these are defined
...
// // ✅ API Routes
// app.use("/api/verify-key", verifyKeyRoute);
...
// // Serve frontend (keep this at the very end!)
// app.get('/*', (req, res) => {
//   res.sendFile(path.join(__dirname, '../frontend/build', 'index.html'));
// });
